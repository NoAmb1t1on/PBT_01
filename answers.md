...
<body>
    <header> <!-- thẻ tiêu đề --> 
        <nav aria-label="breadcrumb"> <!-- chứa link điều hướng -->
            <div class="breadcrumb"> <!-- khai báo class breadcrumb(mục lục) -->
    ...
    <main> <!-- thẻ nội dung chính -->
        ...
        <div class="Pics">
        <img scr="Iphone16_1.png" alt="iphone 16's screen" width="100"> <!-- để chèn ảnh -->
        </div>
        <div class="Pics">
        <img scr="Iphone16_2.png" alt="iphone 16's back" width="100">
        </div>
        <div class="Pics">
        <img scr="Iphone16_3.png" alt="iphone 16's left/right sides" width="100">
        </div>
        <div class="Pics">
        <img scr="Iphone16_4.png" alt="iphone 16's top/bottom sides" width="100">
        </div>
        <div class="Pics">
        <img scr="Iphone16_5.png" alt="backs of 5 iphone 16 with 5 different colors" width="150">
        </div>
